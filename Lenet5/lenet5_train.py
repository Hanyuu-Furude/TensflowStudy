...
def load_mnist(path, kind='train'):
	...
	if kind=='train':
		labels_path=os.path.abspath('train-labels.idx1-ubyte')		
		images_path=os.path.abspath('train-images.idx3-ubyte')
	else:
		labels_path=os.path.abspath('t10k-labels.idx1-ubyte')		
		images_path=os.path.abspath('t10k-images.idx3-ubyte')
